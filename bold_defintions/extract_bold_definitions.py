...
from bold_defintions.functions import useless_beginnings
...
def export_json(bold_defintions_list):
	"""convert to json for use externally"""

	file_path = "temp/bold_defintions.tsv"
	write_tsv_dot_dict(file_path, bold_defintions_list)

	file_path = "temp/bold_defintions.json"
