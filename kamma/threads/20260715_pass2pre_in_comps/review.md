...
- CodeRabbit run launched; still in progress at review write-up — findings
  will be folded in if any arrive

## Verdict
PASSED
- Review date: 2026-07-15
- Reviewer: independent subagent (fresh context) + implementing agent
  applied fixes; CodeRabbit pending
