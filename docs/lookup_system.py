...
if result
    render html of each headword using the `generate_dpd_html` in `/exporter/export_dpd.py`
...
!1 this data is currently generated here `inflections/inflections_to_headwords.py` but yet added to the db model or db tables
