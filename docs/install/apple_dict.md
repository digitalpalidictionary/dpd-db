...
(1) Go to the [latest release page on GitHub](https://github.com/digitalpalidictionary/dpd-db/releases/latest){target="_blank"}.
...
To update to the latest version, download the newest **dpd-apple.dictionary.zip** from [GitHub Releases](https://github.com/digitalpalidictionary/dpd-db/releases/latest){target="_blank"}, unzip it, and replace the existing `Digital-Pali-Dictionary.dictionary` in `~/Library/Dictionaries/`. Restart the Dictionary app to load the new version.
