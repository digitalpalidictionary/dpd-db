...
- **Response:** JSON
    ```json
    {
        ...
        "license": {
            ...
            "attribution": "Digital Pāḷi Dictionary by Bodhirasa Bhikkhu CC BY-NC-SA 4.0",
