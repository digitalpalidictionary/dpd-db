...
def main():
    ...
    html_header += "<thead><tr><th onclick='sortTable(0, event)'>pos &#x2195;</th><th onclick='sortTable(1, event)'>grammar &#x2195;</th><th onclick='sortTable(2, event)'</th><th onclick='sortTable(3, event)'>word &#x2195;</th></tr></thead><tbody>"
