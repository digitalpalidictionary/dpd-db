...
def generate_root_ru_html(db_session: Session,
                       pth: ProjectPaths,
                       dpspth: DPSPaths,
...
def render_root_definition_templ(dpspth: DPSPaths, r: DpdRoots, roots_count_dict):
    """render html of main root info"""

    root_definition_templ = Template(filename=str(dpspth.root_ru_definition_templ_path))
...
def render_root_buttons_templ(dpspth: DPSPaths, r: DpdRoots, db_session: Session):
    """render html of root buttons"""

    root_buttons_templ = Template(filename=str(dpspth.root_ru_button_templ_path))
...
def render_root_info_templ(dpspth: DPSPaths, r: DpdRoots):
    """render html of root grammatical info"""

    root_info_templ = Template(filename=str(dpspth.root_ru_info_templ_path))
...
def render_root_matrix_templ(dpspth: DPSPaths, r: DpdRoots, roots_count_dict):
    """render html of root matrix"""

    root_matrix_templ = Template(filename=str(dpspth.root_ru_matrix_templ_path))
...
def render_root_families_templ(dpspth: DPSPaths, r: DpdRoots, db_session: Session):
    """render html of root families"""

    root_families_templ = Template(filename=str(dpspth.root_ru_families_templ_path))
