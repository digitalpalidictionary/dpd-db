...
- **SuttaCentral Dark Theme**:
  - Background: #414141
  - Accent/Colour: #c68b05
  - Text: #cccccc
  - Detection: Check SuttaCentral's `body` class or computed styles for dark mode indicators (e.g., `theme-dark`, background color).
