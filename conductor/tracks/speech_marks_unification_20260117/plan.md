...
- [ ] Add `speech_marks_path` to `tools/paths.py`
...
- [ ] Create type definitions in `tools/speech_marks.py`
...
- [ ] Implement `SpeechMarkManager.__init__()`
...
- [ ] Write failing tests for `SpeechMarkManager`
...
- [ ] Implement `SpeechMarkManager` to pass all tests (Green phase)
  - Write minimal code to make tests pass
  - Run tests and confirm they pass

- [ ] Refactor `SpeechMarkManager` for clarity
  - Remove duplication, improve performance if needed
  - Ensure code follows project conventions

- [ ] Run ruff on `tools/speech_marks.py`
...
- [ ] Create initial `tools/speech_marks.json`
...
- [ ] Verify `SpeechMarkManager` loads initial JSON correctly
...
- [ ] Update `tools/sandhi_replacement.py`
...
- [ ] Update `gui2/dpd_fields_functions.py`
...
- [ ] Update `gui2/dpd_fields_commentary.py`
  - Same pattern as examples field
  - Update auto-detection and updates

- [ ] Update `gui2/pass1_add_view.py`
  - Update to use `SpeechMarkManager`

- [ ] Update `gui2/pass2_add_view.py`
  - Update to use `SpeechMarkManager`
...
- [ ] Update `exporter/goldendict/export_dpd.py`
...
- [ ] Update `exporter/deconstructor/deconstructor_exporter.py`
  - Load from `SpeechMarkManager.get_speech_marks()`
...
- [ ] Update `db_tests/single/test_hyphenations.py`
...
- [ ] Run ruff on modified test files
...
- [ ] Create feature branch `feature/speech-marks-unification`
...
- [ ] Test exporters with unified system
...
- [ ] Archive old managers on main branch
...
- [ ] Verify final system works on main branch
  - Run `uv run pytest`
