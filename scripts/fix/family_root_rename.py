...
"""Rename a root key in both dpd_roots and dpd_headwords tables.

Edit `before` and `after` in main(), then run:
    uv run scripts/fix/family_root_rename.py
"""
...
def main() -> None:
    ...
    if roots_query:
        ...
        pr.green(f"  dpd_roots: {roots_query.root}")
