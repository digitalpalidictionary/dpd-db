    ...
    for i in dpd_db:
        if i.plus_case and i.meaning_1:
            if " or " in i.plus_case:
                ...
                plus_case_list += [d(i.lemma_1, i.pos, first_case, i.meaning_combo)]
                plus_case_list += [d(i.lemma_1, i.pos, second_case, i.meaning_combo)]
            else:
                plus_case_list += [d(i.lemma_1, i.pos, i.plus_case, i.meaning_combo)]
