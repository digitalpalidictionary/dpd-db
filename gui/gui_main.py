...
from gui.functions_db_dps import (
    dps_get_original_values,
    dps_get_synonyms,
    dps_make_words_to_add_list,
    dps_make_words_to_add_list_filtered,
    dps_make_words_to_add_list_from_text,
    dps_make_words_to_add_list_from_text_filtered,
    dps_make_words_to_add_list_from_text_no_field,
    dps_make_words_to_add_list_sutta,
    dps_update_db,
    fetch_matching_words_from_db,
    fetch_matching_words_from_db_with_conditions,
    fetch_ru,
    fetch_sbs,
    get_next_ids_dps,
    get_next_note_ru,
    get_next_word_ru,
    make_words_to_add_list_from_text,
    make_words_to_add_list_sutta,
    populate_dps_tab,
    update_field,
    update_field_sbs,
    update_field_with_change,
    update_sbs_chant,
    words_in_db_from_source,
    words_in_db_with_value_in_field_sbs,
)
from gui.functions_dps import (
    Flags_dps,
    add_word_from_csv,
    clear_dps,
...
from gui.functions_tests_dps import (
    check_repetition,
    dps_db_internal_tests,
    dps_dpd_db_internal_tests,
    dps_individual_internal_tests,
...
def main():
    ...
    sandhi_dict = sandhi_finder.get_contractions()
