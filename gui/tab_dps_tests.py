...
def make_tab_dps_tests(sg):
    ...
    tab_dps_tests = [
        ...
        [
            ...
            sg.Input("", key="dps_iterations", size=(5, 1)),
        ],
        [
            sg.Text("test 1", size=(15, 1), justification="right"),
            sg.Input("", key="dps_search_column_1", size=(20, 1)),
            sg.Combo(LOGIC, key="dps_search_sign_1", size=(19, 1)),
            sg.Input("", key="dps_search_string_1", size=(30, 1)),
        ],
        [
            sg.Text("test 2", size=(15, 1), justification="right"),
            sg.Input("", key="dps_search_column_2", size=(20, 1)),
            sg.Combo(LOGIC, key="dps_search_sign_2", size=(19, 1)),
            sg.Input("", key="dps_search_string_2", size=(30, 1)),
        ],
        [
            sg.Text("test 3", size=(15, 1), justification="right"),
            sg.Input("", key="dps_search_column_3", size=(20, 1)),
            sg.Combo(LOGIC, key="dps_search_sign_3", size=(19, 1)),
            sg.Input("", key="dps_search_string_3", size=(30, 1)),
        ],
        [
            sg.Text("test 4", size=(15, 1), justification="right"),
            sg.Input("", key="dps_search_column_4", size=(20, 1)),
            sg.Combo(LOGIC, key="dps_search_sign_4", size=(19, 1)),
            sg.Input("", key="dps_search_string_4", size=(30, 1)),
        ],
        [
            sg.Text("test 5", size=(15, 1), justification="right"),
            sg.Input("", key="dps_search_column_5", size=(20, 1)),
            sg.Combo(LOGIC, key="dps_search_sign_5", size=(19, 1)),
            sg.Input("", key="dps_search_string_5", size=(30, 1)),
        ],
        [
            sg.Text("test 6", size=(15, 1), justification="right"),
            sg.Input("", key="dps_search_column_6", size=(20, 1)),
            sg.Combo(LOGIC, key="dps_search_sign_6", size=(19, 1)),
            sg.Input("", key="dps_search_string_6", size=(30, 1)),
        ],
        [
            sg.Text("display", size=(15, 1), justification="right"),
            sg.Input("", key="dps_display_1", size=(20, 1)),
            sg.Input("", key="dps_display_2", size=(20, 1)),
            sg.Input("", key="dps_display_3", size=(30, 1)),
        ],
        [
            sg.Text("error col msg", size=(15, 1), justification="right"),
            sg.Input("", key="dps_error_column", size=(20, 1)),
            sg.Combo(
                [], key="dps_exceptions", size=(20, 1), auto_size_text=False),
        ],
        [
            sg.Text("", size=(15, 1)),
