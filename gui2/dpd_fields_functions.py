...
def find_stem_pattern(pos: str, grammar: str, lemma_1: str) -> tuple[str, str]:
    ...
    if pos == "adj":
        ...
        if lemma_1_clean.endswith("a"):
            ...
            stem = lemma_1_clean[:-1]
            pattern = "u nt"
        elif lemma_1_clean.endswith("āni"):
            stem = lemma_1_clean[:-3]
            pattern = "a nt pl"
        elif lemma_1_clean.endswith("i"):
            stem = lemma_1_clean[:-1]
        ...
        if lemma_1_clean.endswith("anta"):
            stem = lemma_1_clean[:-4]
            pattern = "anta prp"
        elif lemma_1_clean.endswith("enta"):
            stem = lemma_1_clean[:-4]
            pattern = "enta prp"
        elif lemma_1_clean.endswith("onta"):
            stem = lemma_1_clean[:-4]
            pattern = "onta prp"
        elif lemma_1_clean.endswith("māna"):
            stem = lemma_1_clean[:-4]
            pattern = "māna prp"
        ...
        if lemma_1_clean.endswith("ati"):
            stem = lemma_1_clean[:-3]
            pattern = "ati pr"
        elif lemma_1_clean.endswith("eti"):
            stem = lemma_1_clean[:-3]
            pattern = "eti pr"
        elif lemma_1_clean.endswith("oti"):
            stem = lemma_1_clean[:-3]
            pattern = "oti pr"
        elif lemma_1_clean.endswith("āti"):
            stem = lemma_1_clean[:-3]
            pattern = "āti pr"
