if (typeof DictionaryPanel === "undefined") {
  window.DictionaryPanel = class {
          ...
          if (target) {
            if (this.settings.oneButton) {
              ...
              allContentAreas.forEach((area) => {
                if (area !== target && !area.classList.contains("summary"))
    ...
    _initGrammarSorter() {
      const tables = this.content.querySelectorAll(
    ...
    _createHeader() {
      ...
      stickyMsg.textContent =
        "double-click any word on the webpage or sidebar to search";
    ...
    _setupSettingsEventListeners() {
      ...
      var fontSizeDisplay = document.getElementById(
        "settings-font-size-display",
      );
      ...
      document.getElementById("settings-niggahita-toggle").onchange = (e) =>
        this._saveSetting("niggahita", e.target.checked);
      document.getElementById("settings-grammar-toggle").onchange = (e) =>
        this._saveSetting("grammar", e.target.checked);
      document.getElementById("settings-example-toggle").onchange = (e) =>
        this._saveSetting("example", e.target.checked);
      document.getElementById("settings-onebutton-toggle").onchange = (e) =>
        this._saveSetting("oneButton", e.target.checked);
      document.getElementById("settings-summary-toggle").onchange = (e) =>
        this._saveSetting("summary", e.target.checked);
      document.getElementById("settings-sandhi-toggle").onchange = (e) =>
        this._saveSetting("sandhi", e.target.checked);
      document.getElementById("settings-audio-toggle").onchange = (e) =>
        this._saveSetting("audio", e.target.checked);
    }
