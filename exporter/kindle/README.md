...
1.  **Rendering:** `kindle_exporter.py` iterates through the database and uses specialized Jinja2 templates (`templates_jinja2/`) to generate the HTML and metadata files required for a Kindle dictionary.
