...
function hoverHelp(event) {
    if (event == "searchBox1") {
        ...
        bdFooterText.innerHTML = 'For detailed information on this feature, please visit the <a href="https://digitalpalidictionary.github.io/dpdict_bd.html" target="_blank">DPD docs website</a>. This uses <a href="https://github.com/VipassanaTech/tipitaka-xml" target="_blank">Vipassana Research Institute</a> texts'
    }
}
